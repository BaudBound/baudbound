...
pub(crate) use variables::{
    ...
    coerce_variable_value, empty_value_for_declared_type, integer_from_value, number_from_value,
    number_value, refresh_derived_variable_metadata, remove_object_field, set_object_field,
